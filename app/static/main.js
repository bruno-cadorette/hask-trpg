...
var $author$project$Main$SelectTwo = F2(
	function (a, b) {
		return {$: 'SelectTwo', a: a, b: b};
	});
var $author$project$Main$addSelection = F2(
	function (_new, selection) {
		switch (selection.$) {
			case 'SelectNone':
				return $author$project$Main$SelectOne(_new);
			case 'SelectOne':
				var existing = selection.a;
				return A2($author$project$Main$SelectTwo, existing, _new);
			default:
		...
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$GameApi$jsonEncPlayerInput(body)),
				...
				url: A3(
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(capture_gameId),
							'gameState',
							$elm$core$String$fromInt(capture_playerId)
						]),
					params)
			});
	});
			...
			case 'Select':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selection: A2($author$project$Main$addSelection, r, model.selection)
						}),
...
var $author$project$Main$SendCommand = {$: 'SendCommand'};
...
var $author$project$Main$createTable = F2(
	function (len, f) {
		var lst = A2($elm$core$List$range, 0, len);
		var row = function (i) {
			return A2(
				$elm$core$List$map,
				function (j) {
...
var $author$project$Main$individualButton = F2(
	function (i, j) {
		return A2(
...
var $author$project$Main$regionIdToString = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	return '(' + ($elm$core$String$fromInt(a) + (', ' + ($elm$core$String$fromInt(b) + ')')));
};
var $author$project$Main$showSelection = function (selection) {
	switch (selection.$) {
		case 'SelectNone':
			return '()';
		case 'SelectOne':
			var r = selection.a;
			return $author$project$Main$regionIdToString(r);
		default:
			var a = selection.a;
			var b = selection.b;
			return $author$project$Main$regionIdToString(a) + (' -> ' + $author$project$Main$regionIdToString(b));
	}
};
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Main$createTable, 10, $author$project$Main$individualButton),
				$elm$html$Html$text(
				$author$project$Main$showSelection(model.selection)),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$SendCommand)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Send command')
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				{selection: $author$project$Main$SelectNone, units: $elm$core$Dict$empty},
				$elm$core$Platform$Cmd$none);
		},
